...
def gerar_pptx():
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        prs.save(pptx_path)
        return send_file(pptx_path, as_attachment=True, download_name="relatorio.pptx", mimetype='application/vnd.openxmlformats-officedocument.presentationml.presentation')
